...
public final class Constants {
  ...
  public static final class FuelConstants {
    ...
    public static final double INTAKING_FEEDER_VOLTAGE = -12; //-12
    public static final double INTAKING_INTAKE_VOLTAGE = 10; //10
    public static final double LAUNCHING_FEEDER_VOLTAGE = 9; //9
